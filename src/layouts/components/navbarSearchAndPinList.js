export default {
    ...
    // APPS
		{index: 2, label: 'Todo', url: '/apps/todo', labelIcon: 'CheckSquareIcon', highlightAction: false},
		{index: 3, label: 'Chat', url: '/apps/chat', labelIcon: 'MessageSquareIcon', highlightAction: false},
		{index: 4, label: 'Email', url: '/apps/email', labelIcon: 'MailIcon', highlightAction: false},
	    {index: 5, label: 'Calendar', url: '/apps/calendar', labelIcon: 'CalendarIcon', highlightAction: false},
	    {index: 6, label: 'E-Commerce Shop', url: '/apps/eCommerce/shop', labelIcon: 'ShoppingCartIcon', highlightAction: false},
